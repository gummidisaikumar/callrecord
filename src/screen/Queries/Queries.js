...
import {TouchableOpacity, View, Text, PermissionsAndroid} from 'react-native';
...
const Queries = ({navigation}) => {
  ...
  const onRecord = async () => {
    ...
    SoundRecorder.start(SoundRecorder.PATH_DOCUMENT + prefixPath).then(
      function() {
            ...
            <View style={[Styles.gridSection, Styles.alignItems_center]}>
              {!isPlay ? (
                ...
                <TouchableOpacity
                  ...
                  <View>
                    <Icon name={'play-circle'} size={60} color={colors.green} />
                  </View>
                </TouchableOpacity>
              )}
            </View>
          ...
          <TouchableOpacity
            ...
            <View
              style={[
                ...
                subject === 'Select Subject' ? buttonStyles.disabledBtn : '',
              ]}>
